...
//    private static final String TAG = "MSnake";
    ...
    public void initNewGame() {
        ...
        mSnakeTrail.add(new Coordinate(7, 57));
        mSnakeTrail.add(new Coordinate(6, 57));
        mSnakeTrail.add(new Coordinate(5, 57));
        mSnakeTrail.add(new Coordinate(4, 57));
        mSnakeTrail.add(new Coordinate(3, 57));
        mSnakeTrail.add(new Coordinate(2, 57));
